...
public:
    ReplicationServiceBackend(ReplicationServiceImpl* svc) : m_svc{svc} {};
    virtual ~ReplicationServiceBackend() = default;
    virtual std::shared_ptr< StateMachineStore > create_state_store(std::string const& gid) = 0;
